...
const App = () => {
  ...
  let removeProduct = (id) => {
    let filterProduct = product.filter((elem) => elem.id !== id);
    setAllProducts(filterProduct);
  };

  return (
    <div className="w-full min-h-screen flex flex-col gap-4  bg-gray-950 text-white  items-center p-4">
      <h1 className="text-4xl text-gray-500">ALL PRODUCTS</h1>

      {product.length === 0 ? (
        <h1 className="text-2xl text-amber-600">NO PRODUCTS AVAILABLE...</h1>
      ) : (
